// AUTO-GENERATED by scripts/gen-detectors.ts — DO NOT EDIT BY HAND.
...
export const trustSignalsRun: () => any = () => ((() => {
  const viewportH = window.innerHeight || 720;
...
export const navigationRun: () => any = () => ((() => {
